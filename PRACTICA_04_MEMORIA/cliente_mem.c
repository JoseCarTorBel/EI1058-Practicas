...
{	
    ...
    */
    ...
    ps = ((unsigned long)direccion_inicio_bloque&mascaraPS)>>7;
    ...
    {   
        ...
        offset = ((unsigned long) direccion_inicio_bloque&mascaraDesp4K); /*Sacamos el offset*/
    ...
    {
        offset = ((unsigned long) direccion_inicio_bloque&mascaraDesp2M);        
    }
...
void imprime_TP()
{
	...
	printk("cliente_mem: Direccion del marco: 0x%016lX. Direccion de la página 0x%016lX\n", 
	      (unsigned long)virt_to_phys((volatile void *)direccion_inicio_bloque)&mascaraMarco,
	      direccion_inicio_bloque&mascaraDesp4K);   
      
    }else{    
      printk("cliente_mem: Direccion del marco: 0x%016lX. Direccion de la página 0x%016lX\n", 
	      (unsigned long)virt_to_phys((volatile void *)direccion_inicio_bloque)&mascaraMarco,
	      direccion_inicio_bloque&mascaraDesp2M);    
    }
}
